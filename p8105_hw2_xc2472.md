...
There are 344 observations in the trashwheel dataset. The variable date
and weight\_tons represents how much trash were collected at that day.
For example, in the date 2014-5-16, 4.31 tons of trash were collected.
There are 24 observation in the trashwheel dataset. The variable `total`
represents the total precipitation, measured in inch. For example, in
